...
async function renderEmployerClients(d){
  ...
  try{
    ...
    const draw=()=>{
      ...
      c.innerHTML=head('Employer Clients','Create, edit, and manage Employer client accounts assigned to this C/TPA.',`<button class="btn btn-orange" id="addEmployerClient" type="button">Add Employer</button><a class="btn btn-outline" href="employer-import.html">Import Employers</a><a class="btn btn-outline" href="employer-controls.html">Service Scope</a>`)
      +`<section class="metrics">
