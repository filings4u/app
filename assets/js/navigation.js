const groups=[
  ...
  {label:'Platform Configuration',links:[['Plans & Features','plan-features.html','PF'],['Integrations','integrations.html','I'],['Billing','billing.html','$'],['Notification Templates','admin-notifications.html','NT'],['Regulatory','admin-regulatory.html','R'],['Roles','admin-roles.html','U'],['Settings','admin-settings.html','S'],['Audit','audit.html','A']]}
];
