...
const ADMIN_NAV = [
  ...
  {group:'C/TPAs',icon:'C',key:'ctpa',context:'Choose a C/TPA',items:[
    ...
    ['Employer Import','ctpa-employer-import.html','employer-import'],
    ...
    ['Pool Access','ctpa-pool-access.html','pool-access'],
    ...
    ['Policy Builder','ctpa-policies.html','policies'],
    ['Clearinghouse','ctpa-clearinghouse.html','clearinghouse'],
    ['Documents & Certificates','ctpa-documents.html','documents'],
    ['Enrollment Agreements','ctpa-enrollment.html','enrollment'],
    ['Reports / MIS','ctpa-reports.html','reports'],
    ['Client Invoicing','ctpa-billing.html','billing'],
    ['White Label','ctpa-branding.html','branding'],
    ['Employer Controls','ctpa-employer-settings.html','employer-settings'],
