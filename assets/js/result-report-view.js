...
const q=new URLSearchParams(location.search),rid=q.get('report'),employer=q.get('employer'),mode=q.get('mode')||'employer',el=document.querySelector('#report');
...
try{
  if(!rid||!employer)throw new Error('Result report reference is incomplete.');
